        ...
        >
          ...
          >
            ...
            >
              <Link
                href="/about-us"
                className="group relative inline-flex min-h-14 w-full items-center justify-center overflow-hidden rounded-full bg-gold px-6 py-4 text-white shadow-[0_0_40px_rgba(4,120,87,0.3)] transition-all duration-300 hover:-translate-y-1 hover:bg-emerald-700 hover:shadow-[0_0_60px_rgba(4,120,87,0.5)] focus:outline-none focus:ring-2 focus:ring-gold focus:ring-offset-2 focus:ring-offset-[#050B14] sm:min-h-0 sm:w-auto sm:px-10 md:px-12"
          ...
          >
            ...
            <div className="relative h-12 w-[2px] overflow-hidden rounded-full bg-white/35 shadow-[0_0_12px_rgba(255,255,255,0.18)]">
              <motion.div 
                className="absolute top-0 h-1/2 w-full rounded-full bg-gold shadow-[0_0_14px_rgba(4,120,87,0.75)]"
                animate={{ top: ["-50%", "100%"] }}
